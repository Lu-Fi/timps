...
|---|---|---:|---:|---:|---:|---|
| `DAYNIGHT` | `daynight.c` | 0 | 21 | 18 | 10 | every probe: ratio verdict and its branch, the structured `probe: r=… lit=… dark=… hr=… verdict=…` line, exposure vs night reference, illuminator-off readings |
