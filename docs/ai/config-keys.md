...
**Applies to timps v1.9.23 (source: `main`, 2026-09-25).**

A statement marked **since v1.9.24 (unreleased)** is already in the source but
not in any tagged release yet — on a v1.9.23 camera the *previous* behaviour is
the one to describe.
