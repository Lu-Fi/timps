...
Everything else here was read out of this repository at **v1.9.23
(2026-09-25)**; a statement marked **since v1.9.24 (unreleased)** is in the
...
Latest release in `CHANGELOG.md` is **1.9.23 (2026-09-25)**. Anything this
file marks "since v1.9.24 (unreleased)" is only in `[Unreleased]` — quote that
