...
Everything else here was read out of this repository at **v1.9.26
(2026-09-26)**; a statement marked **since v1.9.27 (unreleased)** is in the
...
Latest release in `CHANGELOG.md` is **1.9.26 (2026-09-26)**. Anything this
file marks "since v1.9.27 (unreleased)" is only in `[Unreleased]` — quote that
